...
import application_cohort.models
import datetime
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('financial', models.FileField(upload_to=application_cohort.models.user_upload_path)),
                ('rec_letter1', models.FileField(upload_to=application_cohort.models.user_upload_path)),
                ('rec_letter2', models.FileField(blank=True, null=True, upload_to=application_cohort.models.user_upload_path)),
                ('adv_certificates', models.FileField(blank=True, null=True, upload_to=application_cohort.models.user_upload_path)),
                ('olv_certificates', models.FileField(upload_to=application_cohort.models.user_upload_path)),
                ('a_level_school_transcripts', models.FileField(upload_to=application_cohort.models.user_upload_path)),
                ('o_level_school_transcripts', models.FileField(upload_to=application_cohort.models.user_upload_path)),
                ('official_id', models.FileField(upload_to=application_cohort.models.user_upload_path)),
                ('supps', models.FileField(blank=True, null=True, upload_to=application_cohort.models.user_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='application_cohort_activities', to='application_cohort.applicationcohort')),
            ],
        ),
        migrations.CreateModel(
            name='Dependent',
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='application_cohort_dependents', to='application_cohort.applicationcohort')),
            ],
        ),
        migrations.CreateModel(
            name='Distinction',
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='application_cohort_distinctions', to='application_cohort.applicationcohort')),
            ],
        ),
        migrations.CreateModel(
            name='Sibling',
            fields=[
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='application_cohort_siblings', to='application_cohort.applicationcohort')),
            ],
        ),
    ]
