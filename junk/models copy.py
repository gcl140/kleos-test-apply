...
class Application(models.Model):
    ...
    sat_type = models.CharField(max_length=500, blank=True, null=True, choices=[('SAT','SAT'), ('ACT','ACT'), ('AP','AP')])
    ...
    eng_type = models.CharField(max_length=500, blank=True, null=True, choices=[('TOEFL','TOEFL'), ('IELTS','IELTS'), ('Duolingo','Duolingo')])
    ...
    ib_scores = models.FileField(upload_to=user_upload_path, blank=True, null=True)
    csee_results = models.FileField(upload_to=user_upload_path)
    school_transcripts = models.FileField(upload_to=user_upload_path)
    ...
    completeapp = models.BooleanField(default=False)
    ...
    def update_completion_status(self):
        ...
        self.files_signature = all([
            ...
            self.csee_results and self.csee_results.name != '',
            self.school_transcripts and self.school_transcripts.name != '',
    ...
    def completeapps(self):
        if all([
            self.intro_completed,
            self.general_info_completed,
            self.contact_info_completed,
            self.school_info_completed,
            self.family_info_completed,
            self.siblings_completed,
            self.dependents_completed,
            self.financial_info_completed,
            self.activities_completed,
            self.distinctions_completed,
            self.other_inquiries_completed,
            self.writing_completed,
            self.files_signature
        ]):
            # If all fields are True, set completeapp to True
            self.completeapp = True
            self.save()  
            return True
        return False
    ...
    def __str__(self):
        ...
        # self.writing_completed = self.essay

                # def update_completion_status(self):
    #     """Updates completion status for a given section based on field completion"""
    #     if not self.intro_completed == True and self.agreed:
    #         self.intro_completed = True
    #     if not self.general_info_completed == True and self.first_name and self.last_name and self.dob and self.gender and self.nationality and self.place_of_birth:
    #         self.general_info_completed = True
    #     if not self.contact_info_completed == True and self.residency and self.tel1 and self.email1:
    #         self.contact_info_completed = True
    #     if not self.school_info_completed == True and self.adv_school_name and self.adv_school_phone and self.adv_school_email and self.adv_curriculum and self.olv_school_name and self.olv_school_phone and self.olv_school_email and self.olv_curriculum:
    #         self.school_info_completed = True
    #     if not self.family_info_completed == True and self.par1_fname and self.par1_lname and self.par1_phone and self.par1_email:
    #         self.family_info_completed = True
    #     # Other sections are completed when at least one item exists
    #     if not self.siblings_completed == True and self.application_siblings.exists():
    #         self.siblings_completed = True
    #     if not self.dependents_completed == True and self.application_dependents.exists():
    #         self.dependents_completed = True
    #     if not self.activities_completed == True and self.application_activities.exists():
    #         self.activities_completed = True
    #     if not self.distinctions_completed == True and self.application_distinctions.exists():
    #         self.distinctions_completed = True
    #     if not self.other_inquiries_completed == True and self.form_4_holiday:
    #         self.other_inquiries_completed = True
    #     if not self.writing_completed == True and self.essay:
    #         self.writing_completed = True
        
    #     self.save()


            # self.financial.name != '',  # Check if file is uploaded
            # self.rec_letter1.name != '',
            # self.csee_results.name != '',
            # self.school_transcripts.name != '',
            # self.official_id.name != '',
            # self.signature.strip() != ''  # Check signature is not empty
...
class Activity(models.Model):
    ...
    start_year = models.CharField(max_length=500, choices=[('Grade 9','Grade 9'),('Grade 10','Grade 10'),('Grade 11','Grade 11'),('Grade 12','Grade 12')], null=True, blank=True)
    end_year = models.CharField(max_length=500, null=True, blank=True, choices=[('Grade 9','Grade 9'),('Grade 10','Grade 10'),('Grade 11','Grade 11'),('Grade 12','Grade 12')])
...
class Distinction(models.Model):
    ...
    year = models.CharField(max_length=500, choices=[('Grade 9','Grade 9'),('Grade 10','Grade 10'),('Grade 11','Grade 11'),('Grade 12','Grade 12')], null=True, blank=True)
    ...
    def __str__(self):        
        ...
        # Set optional sections to "completed=True" by default
        ##########################
...
##########################
    ...
    # unbpayc = models.CharField(max_length=500, blank=True, null=True)
