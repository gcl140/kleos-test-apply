...
#     model = CustomUser
#     list_display = ['username', 'first_name', 'last_name', 'email', 'is_active', 'is_intern','is_staff']
...
class CustomUserAdmin(UserAdmin):
    model = CustomUser
    list_display = ['username', 'first_name', 'last_name', 'email', 'is_active', 'is_intern', 'date_joined']
    list_filter = ['is_staff', 'is_active', 'is_intern']
    search_fields = ['username', 'email', 'first_name', 'last_name']
    ordering = ['username']
